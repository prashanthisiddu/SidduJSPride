function disableAllFieldsOnInactiveStage(executionContext) {
...
function HideField(executionContext) {
    ...
    var ToolAccess = formContext.getControl("pg_toolaccessrequestor");
    var WorkLocation = formContext.getControl("pg_worklocation");
    var Gender = formContext.getControl("pg_gender");
    var HolidayCalender = formContext.getControl("pg_holidaycalendar");
    var AssetReqDetails = formContext.getControl("pg_assetrequirementdetails");
    var VoiceSupport = formContext.getControl("pg_voicesupport");

    if ((country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && type === 140310000) {
        formContext.getControl("pg_candidateresume").setVisible(true);
    }
    else {
        formContext.getControl("pg_candidateresume").setVisible(false); //
    }
    if (country === 140310002 && type === 140310000) { // Philippines
        ToolAccess.removeOption(140310005);
        ToolAccess.removeOption(140310006);
        WorkLocation.removeOption(140310000)
        WorkLocation.removeOption(140310001)
        WorkLocation.removeOption(140310002)
        WorkLocation.removeOption(140310003)
        WorkLocation.removeOption(140310004)
        WorkLocation.removeOption(140310005)
        WorkLocation.removeOption(140310006)
        Gender.removeOption(140310000);
        HolidayCalender.removeOption(140310001);
        HolidayCalender.removeOption(140310002);
        HolidayCalender.removeOption(140310003);
        HolidayCalender.removeOption(140310004);
        HolidayCalender.removeOption(140310004);
        HolidayCalender.removeOption(140310005);
        HolidayCalender.removeOption(140310006);
        HolidayCalender.removeOption(140310007);
        AssetReqDetails.removeOption(140310001);
        VoiceSupport.removeOption(140310000);
        VoiceSupport.removeOption(140310001);


    }
    if (country === 140310001 && type === 140310000) { // India
        ToolAccess.removeOption(140310008);
        WorkLocation.removeOption(140310007);
        Gender.removeOption(140310000);
        HolidayCalender.removeOption(140310008);
        AssetReqDetails.removeOption(140310002);
        AssetReqDetails.removeOption(140310003);
        AssetReqDetails.removeOption(140310004);
        VoiceSupport.removeOption(140310004);
    }
    if ((country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && type === 140310000) {
        Gender.removeOption(140310003);
        Gender.removeOption(140310004);
    }
}
...
function switchProcess(executionContext) {
    ...
    if (formType !== CREATE_FORM_TYPE) {
        ...
        var dropoutInitiated = formContext.getAttribute("pg_dropoutintiated").getValue();

        if (dropoutInitiated == 1) {
            if (currentStage === 140310002 || currentStage === 140310003 || currentStage === 140310004) {
                formContext.data.process.setActiveProcess("83A416A9-66B5-45DC-A548-0953CDB2C0B2");
                formContext.getAttribute("pg_currentstage").setValue(currentStage);
...
function ShowHideDropoutforTeams(primaryControl) {
    ...
    var country = formContext.getAttribute("pg_country").getValue();
    if (formType !== 1 && type == 140310000 && status == 1 && (country === 140310001 || country === 140310002)) {
...
function validateMobileNumber(executionContext) {
    var formContext = executionContext.getFormContext();
    var mobileNumberAttribute = formContext.getAttribute("pg_mobilenumber");
    var type = formContext.getAttribute("pg_type").getValue();
    var country = formContext.getAttribute("pg_country").getValue();
    var mobileNumberPattern = /^\d{10}$/;
    if (type === 140310000 && (country === 140310001 || country === 140310002)) {
        var mobileNumber = mobileNumberAttribute.getValue();
        if (mobileNumber != null) {

            var flexibleMobileNumberPattern = /^\d{10}$/;

            if (!flexibleMobileNumberPattern.test(mobileNumber)) {
...
function QMGFIELDCHECK(context) {
    ...
    var activeStage = formcontext.data.process.getActiveStage();
    var stageId = activeStage.getId();
    if (stageId === "4da369a2-7910-4f16-8cee-0bcfd281685d" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {
...
function usdojovalues(context) {
    ...
    var country = formcontext.getAttribute("pg_country").getValue();
    if (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) {
...
function GetUserTeams(context) {
    ...
    if (Type != createform) {
        ...
        if (type === 140310000 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 1) {///type == 140310001 changed to 140310000
...
function indiasetdisable(executionContext) {
    ...
    if (Type != createform) {
        var owner = formContext.getAttribute("ownerid").getValue();
        var ownerName = owner[0].name;
        if (username !== ownerName && (country === 140310001 || country === 140310002)) {
            formContext.getControl("pg_firstname").setDisabled(true);
...
function EATOMOVE(executionContext) {
    ...
    prestartbgvstatus = formContext.getAttribute("pg_prestartbgvstatus").getValue();
    filledmedicalinsurance = formContext.getAttribute("pg_filledmedicalinsurance").getValue();
    var activeStage = formContext.data.process.getActiveStage();
    var stageId = activeStage.getId();
    if (Type !== createform) {
        if (Type !== createform) {
            if (stageId === "434713b1-7d96-43df-b36c-d325daef06d7") {
                formContext.data.process.moveNext();
            } else if (stageId === "4da369a2-7910-4f16-8cee-0bcfd281685d" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) { //qmg us
                formContext.data.process.moveNext();
                ...
                (a === true && b === true && c === true && d === true && e === true && f === true && g === true && h === true && prestartbgvstatus === 140310000 || filledmedicalinsurance === true)) { ///////////hr  for india 

                //  formContext.data.process.moveNext();
            } else if (stageId === "4eb007b7-4aa0-457f-aeed-1bd56af15c12") {
                formContext.data.process.moveNext();
            } else if (stageId === "ec153282-5f82-44cb-8cdb-29af81a84186" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {
                formContext.data.process.moveNext();
            } else if (stageId === "4345ff6c-1b88-4999-851d-4fe4fba6f496" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {
                formContext.data.process.moveNext();
...
function processtonextstage(primaryControl) {
    ...
    Xrm.Navigation.openConfirmDialog(confirmStrings, confirmOptions).then(function (success) {
        if (success.confirmed) {
            formContext.data.process.moveNext().then(function () {
                formContext.data.entity.save();
            });
        } else {
...
function Resolvebutton(primaryControl) {  //main form
    ...
    if ((stageId === "af2bd53b-5965-470a-a555-bd6d02ee2211" && type === 140310000) || (stageId === "99c2e43d-e8cb-4af8-b620-2746f8bb4cb2" && type === 140310000) || (type === 140310012 && legalemployeeagrement === true) || (type === 140310004 && itteamcreateemailid === true && itteamringcentralaccess === true && itteamcreateloginpassword === true) || (type !== 140310000 && country !== 140310000) || (type === 140310005 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006))) {///completed stage
        return true;
    }
    else {
        return false;
...
function BPFMove(executionContext) {
    ...
    if (Type != createform) {
        ...
        var prestartbgvstatus = formContext.getAttribute("pg_prestartbgvstatus").getValue();
        var spineemployeerecordcreation = formContext.getAttribute("pg_spineemployeerecordcreation").getValue();
        var spineemployeecodegeneration = formContext.getAttribute("pg_spineemployeecodegeneration").getValue();
        if (stageId === "4a81cbce-6ed8-442d-a4fc-8ee873101d56") {

            formContext.data.process.moveNext();
        }
        else if (stageId === "11a1353a-8929-4e64-84fb-f0fb16960dcc") {
            formContext.data.process.moveNext();
        }
        else if (stageId === "cb5fde85-072a-4bc2-b107-0af5fbe55e2d" && b === true && c === true) { ////audit stage""removed&& a===true 
        ...
        else if (stageId === "408d7424-cb76-4326-b1ec-5f3287f3bdc1" && prestartbgvstatus !== null && spineemployeerecordcreation !== null && spineemployeecodegeneration !== null) {// && a===true && b===true && c!==null){ ////india hrops stage
        ...
        else if (stageId === "6bb2f036-a279-466a-b004-72a93e20ba6c" || currentstage === 140310002 && country !== 140310000 && Dropoutintiated === false) {
...
Onboarding.formEvents = {
    ...
    handleStageMovement: function checklist(context) {
        ...
        if (bpfstage === "QMG" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {
            var A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R;
        ...
        if (bpfstage === "QAT" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {
            var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r;
        ...
        if (bpfstage === "HR" && country === 140310002) {
            var checkallother, msdemployeerecordcreation, assetagreement, collectproemploymentcontract, finalbgvreportc,
                onboardingpaperwork, issueappointmen, ssshdmfpagibigdetailscollected, emergencycontact, launchvmsrecordcreation;

            checkallother = formcontext.getAttribute("pg_checkallotherchildticketsare1oocomplete").getValue();
            msdemployeerecordcreation = formcontext.getAttribute("pg_msdemployeerecordcreation").getValue();
            assetagreement = formcontext.getAttribute("pg_assetagreementcollectedfiled").getValue();
            onboardingpaperwork = formcontext.getAttribute("pg_onboardingpaperworkcollectedfiled").getValue();
            collectproemploymentcontract = formcontext.getAttribute("pg_collectproemploymentcontract").getValue();
            finalbgvreportc = formcontext.getAttribute("pg_finalbgvreportcollectedcleared").getValue();
            filledmedicalinsurance = formcontext.getAttribute("pg_filledmedicalinsurance").getValue();
            issueappointmen = formcontext.getAttribute("pg_issueappointmentletter").getValue();
            launchvmsrecordcreation = formcontext.getAttribute("pg_launchvmsrecordcreation").getValue();
            emergencycontact = formcontext.getAttribute("pg_emergencycontactdetailscollected").getValue();
            ssshdmfpagibigdetailscollected = formcontext.getAttribute("pg_ssshdmfpagibigdetailscollected").getValue();
            if ((bpfArguments.getDirection() === "Next") && (checkallother !== true || msdemployeerecordcreation !== true || assetagreement !== true ||
                collectproemploymentcontract !== true || onboardingpaperwork !== true || finalbgvreportc !== true || filledmedicalinsurance !== true || issueappointmen !== true || launchvmsrecordcreation !== true || emergencycontact !== true || ssshdmfpagibigdetailscollected !== true)) {
                bpfArguments.preventDefault();
        ...
        if (bpfstage === "HR" && country === 140310001) {
            ...
            prestartbgvstatus = formcontext.getAttribute("pg_prestartbgvstatus").getValue(); //pg_prestartbgvstatus2
            filledmedicalinsurance = formcontext.getAttribute("pg_filledmedicalinsurance").getValue();
            if ((bpfArguments.getDirection() === "Next") && (s !== true || t !== true || u !== true ||
                v !== true || w !== true || x !== true || y !== true || z !== true || prestartbgvstatus !== 140310000 || filledmedicalinsurance !== true)) {
                bpfArguments.preventDefault();
                alertStrings = { confirmButtonLabel: "OK", text: "Please complete HR of all requests.", title: "Cannot Move to Next Stage" };
                alertOptions = { height: 200, width: 300 };
                Xrm.Navigation.openAlertDialog(alertStrings, alertOptions);
...
///////////////////////////////////////////////////
function OnBPFStageChangeOnboarding(context) {
    var formContext = context.getFormContext();
    formContext.data.process.addOnStageChange(TAONBOARDFORM);
    TAONBOARDFORM(context);
}
...
function TAONBOARDFORM(executionContext) {                       //mainFORM
    ...
    if ((country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {//US
    ...
    if (country === 140310001 || country === 140310002) {          //india
        TAOnboarding.setVisible(true);
        //TAONBOARDING
        ...
        formContext.getAttribute("pg_department").setRequiredLevel("required");
        formContext.getAttribute("pg_division").setRequiredLevel("required");
    }
    if (country === 140310002) {  // Philippines
        formContext.getControl("pg_launchreq").setVisible(true);
        formContext.getControl("pg_adminstrativemanagername").setVisible(true);
        formContext.getControl("pg_cabdetails").setVisible(false);
        formContext.getControl("pg_relocation").setVisible(false);
        formContext.getControl("pg_teamname").setVisible(false);
    }
    if (country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006 || country === 140310007 || country === 140310008) {
    ...
    if (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006 || country === 140310001 || country === 140310002) { // iif country= india
        TAOnboarding.setVisible(true);
    ...
    var MainManagerPHP = Manager.sections.get("Phillipines");
    var HR = formContext.ui.tabs.get("HR");
    var HROps = formContext.ui.tabs.get("tab_17");
    var HROpsPHP = formContext.ui.tabs.get("tab_18");//tab_18
    ...
    if (stageId === "c08c6d0c-59f5-4286-aeb0-56c8446e7983" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) || stageId === "98d720f3-2395-4920-9994-43e245ea7bc6" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {///manager
    ...
    if (stageId === "c08c6d0c-59f5-4286-aeb0-56c8446e7983" && country === 140310001) {//manager
        Manager.setVisible(true);
    ...
    if (stageId === "c08c6d0c-59f5-4286-aeb0-56c8446e7983" && country === 140310002) {//ManagerPHP
        Manager.setVisible(true);
        MainManagerPHP.setVisible(true);

        formContext.getAttribute("pg_currentstage").setValue(140310001);
    }
    else {
        MainManagerPHP.setVisible(false);

    }
    if (country !== 140310002 && (stageId === "11a1353a-8929-4e64-84fb-f0fb16960dcc" || stageId === "cb5fde85-072a-4bc2-b107-0af5fbe55e2d")) {///audit stage
    ...
    if (country === 140310002 && (stageId === "11a1353a-8929-4e64-84fb-f0fb16960dcc" || stageId === "cb5fde85-072a-4bc2-b107-0af5fbe55e2d")) {///audit stage
        formContext.getAttribute("pg_currentstage").setValue(140310004);
        Audit.setVisible(true);
        formContext.getControl("pg_checkappointmentletterissuance").setVisible(false);
        formContext.getControl("pg_collectprobationaryemploymentcontractissu").setVisible(true);
    }
    else {
        Audit.setVisible(false);
    }
    ...
    if (stageId === "3ebeb3bb-a2cb-40be-8679-f3b70c945661" || stageId === "af634a5d-e6e2-4b47-8f20-b3d71f2708b7" || stageId === "1b929018-05de-45be-9abf-87c69466d2bb" || stageId === "c044166f-470b-4edd-8a7d-b0b2c8c7d862") {
    ...
    if (stageId === "408d7424-cb76-4326-b1ec-5f3287f3bdc1" && country == 140310002) {
        //     formContext.getAttribute("pg_currentstage").setValue(140310006);
        HROpsPHP.setVisible(true);

    }
    else {
        HROpsPHP.setVisible(false);
    }
    ...
    if (stageId === "601fe287-7df7-4244-b549-ca01134f5382" && country == 140310002) {
        formContext.getAttribute("pg_currentstage").setValue(140310003);
        HR.setVisible(true);
        formContext.getControl("pg_day1orientationcompleted").setVisible(false);
        formContext.getControl("pg_poststartbgvinitiation").setVisible(false);
        formContext.getControl("pg_prestartbgvstatus3").setVisible(false);
        formContext.getControl("pg_spineemployeerecordcreation3").setVisible(false);
        formContext.getControl("pg_spineemployeecodegeneration3").setVisible(false);
        formContext.getControl("pg_collectproemploymentcontract").setVisible(true);
        formContext.getControl("pg_launchvmsrecordcreation").setVisible(true);
        formContext.getControl("pg_emergencycontactdetailscollected").setVisible(true);
        formContext.getControl("pg_ssshdmfpagibigdetailscollected").setVisible(true);
    ...
    if (stageId === "1943bd92-6621-45b4-afe6-cf3acf70b9f5" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) || stageId === "340f4ddd-37ca-4ce4-97b0-5076b3670599" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {
        formContext.getAttribute("pg_currentstage").setValue(140310003);
    ...
    if (stageId === "b7900f22-3d52-4d26-bb2d-4b13208f029e" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) || stageId === "dec7bf2c-ef18-431c-9df6-aa5776062f59" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) || stageId === "f91895dc-eb9c-4398-8b78-b596b266aa63" && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {
        ////formContext.getAttribute("pg_currentstage").setValue(140310003);
    ...
    if (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) { // if country= us
        US.setVisible(true);
    }
    else {
        US.setVisible(false);
    ...
    var createform = 1;
    var Type = formContext.ui.getFormType();
    if (Type !== createform && type === 140310000 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006)) {
    ...
    if (Type !== createform && type === 140310000 && country === 140310001 && Dropoutintiated !== true) {
    ...
    if ((Diversehire === 140310000 && type !== 140310000) || Diversehire === 140310001) {///// && type == 140310000
    ...
    if ((country === 140310001 || country === 140310002) && diversitytype !== null && type === 140310000 && Diversehire === 140310000) {
        if (diversitytype.includes(140310000)) {
    ...
    if (Type !== createform && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && type === 140310000) {
    ...
    if (Type !== createform && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && type === 140310005) {
...
function OnboardingSHOW(executionContext) {/////Main Form
    ...
    var ManagerPHP = childtickettab.sections.get("tab_2_section_7");
    ...
    var PHP = childtickettab.sections.get("tab_2_section_6");
    ...
    if (Type !== createform) {
        ...
        // internal Onboarding - IT CAM for PHP
        else if ((type === 140310005 && country === 140310002 && status === 1) || (type === 140310005 && country === 140310002 && status === 140310005)) { /////inprocess
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            ITCAM.setVisible(true);
            PHP.setVisible(true);
            ManagerPHP.setVisible(true);
            Manager.setVisible(false);
            //   formContext.getControl("pg_emailaddressdeleted").setVisible(false);//ITCAM
            //   formContext.getControl("pg_removedfromstandarddls").setVisible(false);
            // formContext.getControl("pg_removedfromcustomdls").setVisible(false);
        ...
        else if ((type === 140310005 && country === 140310002 && status === 140310003) || (type === 140310005 && country === 140310002 && status === 140310004) || (type === 140310005 && country === 140310002 && status === 140310001) || (type === 140310005 && country === 140310002 && status === 140310002)) {
            Onboarding.setVisible(true);
            dropchildtickettab.setVisible(false);
            TAOnboarding.setVisible(false);
            ITCAM.setVisible(true);
        ...
        // Internal Onboarding - Learning & Development for PHP
        else if ((type === 140310006 && country === 140310002 && status === 1) || (type === 140310006 && country === 140310002 && status === 140310005)) {       // inprocess
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            LearningandDevelopment.setVisible(true);
        ...
        else if ((type === 140310006 && country === 140310002 && status === 140310003) || (type === 140310006 && country === 140310002 && status === 140310004) || (type === 140310006 && country === 140310002 && status === 140310001) || (type === 140310006 && country === 140310002 && status === 140310002)) {
            Onboarding.setVisible(true);
            dropchildtickettab.setVisible(false);
            TAOnboarding.setVisible(false);
            LearningandDevelopment.setVisible(true);
        ...
        // Internal Onboarding - IT Helpdesk for PHP
        else if ((type === 140310004 && country === 140310002 && status === 1) || (type === 140310004 && country === 140310002 && status === 140310005)) {  // inprocess
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            ...
            Manager.setVisible(false);
            formContext.getControl("pg_assetcheckedandcleared").setVisible(false);//ITHELPDESK
            formContext.getControl("pg_voicesupport").setVisible(false);
            formContext.getControl("pg_bayallocation").setVisible(false);
            formContext.getControl("pg_voipdisabled").setVisible(false);
        }
        ...
        else if ((type === 140310004 && country === 140310002 && status === 140310003) || (type === 140310004 && country === 140310002 && status === 140310004) || (type === 140310004 && country === 140310002 && status === 140310001) || (type === 140310004 && country === 140310002 && status === 140310002)) {
            Onboarding.setVisible(true);
            dropchildtickettab.setVisible(false);
            TAOnboarding.setVisible(false);
            ITHelpdesk.setVisible(true);
        ...
        // Internal Onboarding - Admin for PHP
        else if ((type === 140310009 && country === 140310002 && status === 1) || (type === 140310009 && country === 140310002 && status === 140310005)) {              //inprocess
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            Admin.setVisible(true);
            ...
            formContext.getControl("pg_assetretreival").setVisible(false);
            formContext.getControl("pg_seatingpreferance").setVisible(false);
            formContext.getControl("pg_assetissued").setVisible(false);
            formContext.getControl("pg_assetagreementissued").setVisible(false);
            formContext.getControl("pg_assetinventoryupdatedintrackertool").setVisible(false);
            formContext.getControl("pg_emailconfiguredinasset").setVisible(false);
            formContext.getControl("pg_voipenabled").setVisible(false);
        ...
        else if ((type === 140310009 && country === 140310002 && status === 140310003) || (type === 140310009 && country === 140310002 && status === 140310004) || (type === 140310009 && country === 140310002 && status === 140310001) || (type === 140310009 && country === 140310002 && status === 140310002)) {
            Onboarding.setVisible(true);
            dropchildtickettab.setVisible(false);
            TAOnboarding.setVisible(false);
        ...
        // Internal Onboarding - Employee Development for PHP
        else if ((type === 140310007 && country === 140310002 && status === 1) || (type === 140310007 && country === 140310002 && status === 140310005)) {    //inprocess
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            ...
            ManagerPHP.setVisible(true);
            Manager.setVisible(false);
            formContext.getControl("pg_pmsorientationcompleted").setVisible(false);
            formContext.getControl("pg_deactivatexyme").setVisible(false);
        }
        ...
        else if ((type === 140310007 && country === 140310002 && status === 140310003) || (type === 140310007 && country === 140310002 && status === 140310004) || (type === 140310007 && country === 140310002 && status === 140310001) || (type == 140310007 && country == 140310002 && status == 140310002)) {
            Onboarding.setVisible(true);
            dropchildtickettab.setVisible(false);
            TAOnboarding.setVisible(false);
            EmployeeDevelopment.setVisible(true);
        ...
        // Internal Onboarding - Employee Engagement for PHP
        else if ((type === 140310010 && country === 140310002 && status === 1) || (type === 140310010 && country === 140310002 && status === 140310005)) {   // inprocess
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            ...
            ManagerPHP.setVisible(true);
            Manager.setVisible(false);
            formContext.getControl("pg_removenameinmmmsingerslist").setVisible(false);
        ...
        else if ((type === 140310010 && country === 140310002 && status === 140310003) || (type === 140310010 && country === 140310002 && status === 140310004) || (type == 140310010 && country == 140310002 && status == 140310001) || (type == 140310010 && country == 140310002 && status == 140310002)) {
            Onboarding.setVisible(true);
            dropchildtickettab.setVisible(false);
            TAOnboarding.setVisible(false);
            EmployeeEngagement.setVisible(true);
        ...
        // Internal Onboarding - Finance for PHP
        else if ((type === 140310008 && country === 140310002 && status === 1) || (type === 140310008 && country === 140310002 && status === 140310005)) {
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            Finance.setVisible(true);
            ...
            ManagerPHP.setVisible(true);
            Manager.setVisible(false);
            formContext.getControl("pg_addtofinancemasterfile").setVisible(true);

            formContext.getControl("pg_verifyssshdmfpagibigdetails").setVisible(true);
            formContext.getControl("pg_approvetaxdeclarations").setVisible(false);
            formContext.getControl("pg_enableemployeebenefitsopted").setVisible(false);
            formContext.getControl("pg_shareemployeeinsurancenumforesiccardissua").setVisible(false);
        }
        ...
        else if ((type === 140310008 && country === 140310002 && status === 140310003) || (type === 140310008 && country === 140310002 && status === 140310004) || (type === 140310008 && country === 140310002 && status === 140310001) || (type === 140310008 && country === 140310002 && status === 140310002)) {
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            Finance.setVisible(true);
        ...
        ///HRBP for PHP
        else if ((type === 140310014 && country === 140310002 && status === 1) || (type === 140310014 && country === 140310002 && status === 140310005)) {
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            HRBP.setVisible(true);
        ...
        ///HRBP
        else if ((type === 140310014 && country === 140310002 && status === 140310003) || (type === 140310014 && country === 140310002 && status === 140310004) || (type === 140310014 && country === 140310002 && status === 140310001) || (type === 140310014 && country === 140310002 && status === 140310002)) {
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
            HRBP.setVisible(true);
        ...
        else if ((type === 140310004 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 1) || (type === 140310004 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 140310005)) {           // inprocess//////us///ithelpdesk
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
        ...
        else if ((type === 140310005 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 1) || (type === 140310005 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 140310005)) { /////inprocess////itcam
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
        ...
        else if ((type === 140310013 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 1) || (type === 140310013 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 140310005)) { /////inprocess////EmploymentAgreement
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
        ...
        // Internal Onboarding - Admin
        else if ((type === 140310009 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 1) || (type === 140310009 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 140310005)) {
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
        ...
        ////Legal
        else if ((type === 140310012 && country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006 && status === 1) || (type === 140310012 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 140310005) || (type === 140310012 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 140310001) || (type === 140310012 && (country === 140310000 || country === 140310003 || country === 140310004 || country === 140310005 || country === 140310006) && status === 140310002)) {           // inprocess//////us
            Onboarding.setVisible(true);
            childtickettab.setVisible(true);
            TAOnboarding.setVisible(false);
